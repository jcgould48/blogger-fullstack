...
class  App extends Component {
    ...
    constructor(){
        ...
        // this.onDelete = this.onDelete.bind(this) //this would be for the onDelete when it is not a big arrow function like the componentDidMount
    }
    loadBlogs(){
        const url = '/blogs' //works in conjuction with 'proxy' in package.json
